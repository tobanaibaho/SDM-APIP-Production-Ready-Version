            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                >
                    ...
                    <div className="relative z-10 p-10 flex flex-col md:flex-row items-center gap-10">
                        ...
                        <div className="relative group shrink-0">
                            <div className="h-32 w-32 md:h-40 md:w-40 rounded-[2.5rem] bg-gradient-to-br from-primary-500 to-primary-700 p-1.5 shadow-2xl transform transition-transform group-hover:scale-[1.05] group-hover:rotate-2">
                        ...
                        <div className="flex-1 min-w-0 text-center md:text-left">
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-wrap justify-center md:justify-start gap-4">
                                    <span className="inline-flex items-center gap-2 rounded-2xl bg-primary-50 px-5 py-2 text-[11px] font-black text-primary-700 border border-primary-100 uppercase tracking-widest shadow-sm">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-12 xl:col-span-7 space-y-8">
                        ...
                        >
                            <div className="px-8 py-6 border-b border-primary-100 flex items-center justify-between bg-primary-50/20">
                            ...
                            <div className="p-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-6">
                                        <div className="group">
                                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 group-hover:text-primary-500 transition-colors">Nama Lengkap</p>
                                        ...
                                        <div className="group">
                                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 group-hover:text-primary-500 transition-colors">Pangkat / Golongan</p>
                                    ...
                                    <div className="space-y-6">
                                        <div className="group">
                                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 group-hover:text-primary-500 transition-colors">NIP / Identitas Akun</p>
                                        ...
                                        <div className="group">
                                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 group-hover:text-primary-500 transition-colors">Pendidikan Terakhir</p>
                                            <div className="flex items-center gap-3 bg-slate-50/50 px-5 py-4 rounded-2xl border border-slate-100 text-sm font-black text-slate-800 transition-all group-hover:bg-white group-hover:shadow-sm">
                                    ...
                                    <div className="md:col-span-2 group">
                                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 group-hover:text-primary-500 transition-colors">Alamat Unit Kerja</p>
                                        <div className="flex items-center gap-3 bg-slate-50/50 px-5 py-4 rounded-2xl border border-slate-100 text-sm font-black text-slate-800 transition-all group-hover:bg-white group-hover:shadow-sm">
                    ...
                    <div className="lg:col-span-12 xl:col-span-5 space-y-8">
                        ...
                        >
                            ...
                            <div className="space-y-6 flex-1">
                                <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-primary-200">
                        ...
                        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-md">
                            ...
                            >
                                <div className="bg-slate-900 p-8 text-center text-white relative">
                                    <div className="h-16 w-16 rounded-[1.5rem] bg-primary-500 mx-auto mb-6 flex items-center justify-center shadow-xl shadow-primary-500/20">
                                        <Shield size={32} className="text-white" strokeWidth={2.5} />
                                    </div>
                                    <h3 className="text-2xl font-black italic tracking-tight">Setup MFA</h3>
                                    <p className="text-primary-400 text-[10px] font-black uppercase tracking-[0.2em] mt-2">Proteksi Akun Tingkat Tinggi</p>
                                </div>
                                        ...
                                        <div className="w-full space-y-5">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full text-center text-4xl font-black tracking-[0.4em] py-5 bg-primary-50/50 border-2 border-transparent focus:border-primary-500 focus:bg-white rounded-[2rem] outline-none transition-all placeholder:text-slate-200"
                                                    placeholder="000000"
                                                    autoFocus
                                                />
                                            </div>
