        ...
        <div className="min-h-screen bg-slate-100 flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-md z-10 animate-fade-in">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="font-serif text-2xl font-bold text-primary-900 uppercase tracking-wide leading-snug drop-shadow-sm">INSPEKTORAT<br />KEMENKO INFRA</h1>
                ...
                <p className="mt-8 text-center text-slate-400 text-xs font-medium">
                    &copy; {new Date().getFullYear()} Inspektorat Kemenko Infra
                </p>
            </div>
        </div>
    );
